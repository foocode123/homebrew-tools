class FoocodeCli < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://tools.veracode.com/veracode-cli/veracode-cli_3.2.2_macosx_arm64.tar.gz"
      sha256 "d77b2aa19842b67f4b5a509300b6afbe7c8fbb934afbd932392b1fd457756fb2"
    elsif Hardware::CPU.intel?
      url "https://tools.veracode.com/veracode-cli/veracode-cli_3.2.2_macosx_x86.tar.gz"
  ...
  on_linux do
    url "https://tools.veracode.com/veracode-cli/veracode-cli_3.2.2_linux_x86.tar.gz"
